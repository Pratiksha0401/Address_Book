package com.AddressBook_IOStream;
...
public class AddressBook {
    ...
    private static File file = new File("D:\\Pratiksha\\Java_programs\\Day_6\\Address_Book\\ContactFile.txt");
    ...
    public static void printData() throws IOException {
		try {
			Files.lines(new File("D:\\Pratiksha\\Java_programs\\Day_6\\Address_Book\\ContactFile.txt").toPath())
